...
//         setMessage("ERROR: User not found. Please register.");
//       } else if (status === 422) {
//         setMessage("ERROR: Invalid request. Please re-enter credentials.");
//       } else {
//         setMessage(`ERROR: Login failed. ${serverMsg || "Please try again."}`);
//       }
//     } finally {
...
//       <div className="bg-white shadow-2xl border border-indigo-100 rounded-3xl p-10 w-full max-w-md text-center">
//         {/* Logo + Header */}
//         <div className="flex flex-col items-center mb-6">
//           <img
//             src="/trendvista_logo.svg"
//             alt="TrendVista"
...
//             Welcome back, To AI powered Trend Analyzer.
//           </p>
//         </div>
...
//         {message && (
//           <div
//             className={`text-sm py-2 px-3 rounded-md border mb-4 ${
//               message.startsWith("SUCCESS")
...
//               onChange={(e) => setEmail(e.target.value)}
//               disabled={loading}
//               className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
//             />
//           </div>
...
//                 onChange={(e) => setPassword(e.target.value)}
//                 disabled={loading}
//                 className="w-full border border-gray-300 rounded-lg px-4 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
//               />
//               <button
//                 type="button"
//                 onClick={() => setShowPassword(!showPassword)}
...
//             type="submit"
//             disabled={loading}
//             className="w-full bg-indigo-600 text-white py-2.5 rounded-md font-semibold hover:bg-indigo-700 transition-all disabled:opacity-60"
//           >
//             {loading ? "Logging in..." : "Login"}
//           </button>
//         </form>
...
//         <p className="text-sm text-gray-500 mt-3 hover:text-indigo-600 cursor-pointer">
//           Forgot your Password?
//         </p>
//       </div>
//     </div>
